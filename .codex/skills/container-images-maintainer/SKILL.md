...
- Never publish production image refs manually from a workstation. Use the GitHub Actions release workflow by pushing an image-scoped version tag such as `learnspam/v0.1.1`.
